...
| **Location**          | [BookingCalendar.tsx](theramate-ios-client/app/(practitioner)/(ptabs)/schedule/ + src/pages/practice/UpcomingSessions.tsx) (therapist branch, mapping of sessions to BookingEvent).                                            |
| **Priority**          | **P0**                                                                                                                                                                                                                         |
...
| **Current behavior**  | Per [BOOKING_FLOW_AUDIT_REPORT.md](docs/troubleshooting/booking-flow-step-map.md "or search repo for audit"), authenticated flow may create sessions with `status: 'scheduled'` before payment, while guest flow uses `pending_payment`. |
...
| **Location**          | [BookingFlow.tsx](src/components/booking/BookingFlow.tsx) (authenticated), create_booking_with_validation, stripe-webhooks.                                                                                                              |
| **Priority**          | **P1**                                                                                                                                                                                                                                   |
...
| **Location**          | Supabase migrations (or external DB), [AuthCallback.tsx](search src/ for OAuth / auth callback), [messaging.ts](src/components/messaging/RealTimeMessaging.tsx).                                                        |
| **Priority**          | **P2**                                                                                                                                                                                                                  |
