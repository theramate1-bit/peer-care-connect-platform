...
create function public.get_practitioner_mobile_requests(
...
grant execute on function public.get_practitioner_mobile_requests(uuid, text) to authenticated, anon;
