-- First, let's create the new enums
DO $$ BEGIN
...
-- Add new columns (don't set defaults yet to avoid conflicts)
...
-- Update existing data to map old roles to new user_role values
UPDATE public.users 
SET user_role = 'sports_therapist', onboarding_status = 'pending'
WHERE user_role IS NULL;

-- Now set the defaults and make user_role non-null
ALTER TABLE public.users 
