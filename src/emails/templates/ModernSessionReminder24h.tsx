...
interface ModernSessionReminder24hProps {
  recipientName?: string;
  data: EmailData;
  baseUrl?: string;
}

export const ModernSessionReminder24h = ({
  recipientName,
  data,
  baseUrl = 'https://theramate.co.uk',
}: ModernSessionReminder24hProps) => {
  ...
  const heroTitle = `Your session is tomorrow!`;
  const heroSubtitle = `This is a friendly reminder that you have a ${data.sessionType || 'session'} scheduled for tomorrow.`;
...
export default ModernSessionReminder24h;
