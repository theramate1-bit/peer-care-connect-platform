...
import { CalendarIcon, Clock, RefreshCw, AlertCircle, CheckCircle } from 'lucide-react';
...
export const RescheduleBooking: React.FC<RescheduleBookingProps> = ({
  ...
  useEffect(() => {
    if (open) {
      ...
      // Load available times (simplified - in production, fetch from practitioner availability)
      fetchAvailableTimeSlots();
    }
  }, [open, booking.id]);

  const fetchAvailableTimeSlots = async () => {
    // Use BookingFlow's time slot fetching logic
    // For now, generate standard time slots
    const slots: string[] = [];
