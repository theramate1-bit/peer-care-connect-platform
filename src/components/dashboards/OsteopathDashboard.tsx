...
export const OsteopathDashboard = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      setStats({
        ...
        structuralAssessments: 78, // Mock data - would come from assessment tracking
        treatmentSuccessRate: 91 // Mock data - would come from treatment outcomes
      });
  ...
  const osteopathyQuickActions = [
    { 
      ...
      description: "Manage patient cases and treatment plans" 
    },
    { 
      ...
      description: "Conduct musculoskeletal assessments" 
    },
    { 
    ...
    { 
      ...
      description: "Monitor pain reduction and recovery" 
    }
  ];
      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {/* Booking Calendar */}
            <BookingCalendar userType="osteopath" />
          </div>

          {/* Sidebar */}
          <div className="space-y-6">
            {/* Osteopathy Quick Actions */}
            <Card>
              <CardHeader>
                <CardTitle>Osteopathy Actions</CardTitle>
                <CardDescription>Access your most used osteopathy features</CardDescription>
              </CardHeader>
              <CardContent>
