// Fix script for the specific user with incomplete data
...
async function fixSpecificUser() {
  console.log('🔧 Fixing specific user data...\n');
  ...
  try {
    ...
    if (userError) {
      ...
      console.log('✅ Updated user profile:', {
        ...
        avatar_preferences: updatedUser.avatar_preferences ? 'Present' : 'Missing'
      });
    }
