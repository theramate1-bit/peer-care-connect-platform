...
const hasTherapistProfilesTable = migrationContent.includes('therapist_profiles');
const hasMarketplaceFields = migrationContent.includes('professional_statement') && migrationContent.includes('treatment_philosophy');
...
const hasRedirectAfterSuccess = registerContent.includes('navigate(\'/auth/verify-email\')');
