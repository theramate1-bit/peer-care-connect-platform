      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-8">
          {userTypes.map((userType) => {
            ...
            return (
              <Card key={userType.type} className={`relative overflow-hidden border-2 ${userType.borderColor} transition-[border-color,transform] duration-200 ease-out hover:-translate-y-1 sm:hover:-translate-y-2 h-full flex flex-col will-change-transform`}>
                ...
                <CardContent className="pt-8 p-6 flex-1 flex flex-col h-min-content">
