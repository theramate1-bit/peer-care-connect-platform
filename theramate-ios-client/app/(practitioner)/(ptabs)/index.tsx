...
export default function PractitionerHomeScreen() {
  ...
  const name =
    userProfile?.first_name || userProfile?.full_name?.split(" ")[0] || "there";
          ...
          right={
            !isLoading && !isError && dash ? (
              ...
              >
                ...
                {dash.unreadNotificationsCount > 0 ? (
                  <View className="absolute -top-0.5 -right-0.5 min-w-[18px] h-[18px] rounded-full bg-sage-500 items-center justify-center px-1">
