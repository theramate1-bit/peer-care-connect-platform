  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        `The full Terms and Conditions on the website (${APP_CONFIG.TERMS_URL}) take precedence if there is any inconsistency with this in-app summary. Nothing in these terms limits statutory rights that cannot be limited under UK law (including the Consumer Rights Act 2015 for consumers where applicable).`,
      ],
    },
    {
      heading: "Agreement",
